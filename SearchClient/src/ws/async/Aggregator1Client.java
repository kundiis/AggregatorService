...
import ws.async.Aggregator1Stub.Search;
import ws.async.Aggregator1Stub.SearchResponse;
import ws.async.Aggregator1Stub.SearchTo;
public class Aggregator1Client {
	...
	public static void main(String[] args) {
		...
		try {
			Aggregator1Stub test = new ws.async.Aggregator1Stub(props.getProperty("aggregator1Url"));
