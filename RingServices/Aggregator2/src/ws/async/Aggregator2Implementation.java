...
import org.example.www.aggregator2.Search;
import org.example.www.aggregator2.SearchAppendandPass;
import org.example.www.aggregator2.SearchAppendandPassResponse;
import org.example.www.aggregator2.SearchGoldBox;
import org.example.www.aggregator2.SearchGoldBoxResponse;
import org.example.www.aggregator2.SearchResponse;
...
public class Aggregator2Implementation extends Thread implements  Aggregator2SkeletonInterface{
	...
	public SearchResponse search(Search search) {
		...
		saap.setOriginID(2); // id of the 1st WS
		...
		System.out.println("Video Aggregator Called by client....");
		int i=0;
	...
	public SearchAppendandPassResponse searchAppendandPass(
		...
		StoreClient<String,byte[]> client = factory.getStoreClient("results");
		System.out.println("Video Aggregator initiated....");
	...
	/**
	 * Use this method to make WS as a gold Box.
	 */
	...
	public SearchGoldBoxResponse searchGoldBox(SearchGoldBox searchGoldBox) {
		...
		response.setOut(new SearchVideo().searchData(searchGoldBox.getIn()));
		return response;
	}
